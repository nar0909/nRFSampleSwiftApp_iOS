...
class ButtonCNT1: UIViewController, CBPeripheralManagerDelegate, UITextViewDelegate, UITextFieldDelegate {
    ...
    @IBAction func sliderValueChanged(_ sender: UISlider) {
       ...
       //Code to show slider value in the label text box
        value = Int(UInt8(sender.value))
        //type casting the float to int in above step
