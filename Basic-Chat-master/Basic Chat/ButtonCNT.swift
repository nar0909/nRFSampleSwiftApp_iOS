...
class ButtonCNT: UIViewController, CBPeripheralManagerDelegate, UITextViewDelegate, UITextFieldDelegate {
    ...
    func outgoingData () {
        ...
        performSegue(withIdentifier: "CNT1", sender: self)
    ...
    //CNT2 pressed
    //CNT1 pressed
    @IBAction func clickSendAction2(_ sender: AnyObject) {
        outgoingData2()
    ...
    func outgoingData2 () {
        ...
        //CNT is the name of the "Segue" branch -  present modally
        performSegue(withIdentifier: "CNT2", sender: self)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        else if segue.destination is ButtonCNT2
        {
            let vc2 = segue.destination as? ButtonCNT2
            
            vc2?.peripheral = blePeripheral
        }
